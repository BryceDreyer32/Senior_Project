...
#                  "}")
    ...
    def processPs4Data(self, data):
        ...
        match ( data[0] ):
            ...
            case Constants.Constants.VOLTAGE_ONLY_FRAME       : self.getVoltage( data )
    ...
    def getVoltage(self, data):
        ...
        self.Voltage_Label.setText(str(voltage))
        print("Voltage read = " + str(voltage))
