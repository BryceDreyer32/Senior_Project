...
class Constants:
    ...
    ROTATION0_TARGET_ANGLE_ADDR	    = 0x0E
    ROTATION0_CURRENT_ANGLE_ADDR    = 0x0F
    ROTATION0_CURRENT_ANGLE2_ADDR   = 0x10
    ROTATION1_CONTROL_ADDR		    = 0x11
    ROTATION1_STATUS_ADDR		    = 0x12
    ROTATION1_ROTATION_ADDR		    = 0x13
    ROTATION1_CURRENT_ANGLE_ADDR    = 0x14
    ROTATION1_CURRENT_ANGLE2_ADDR   = 0x15
    ROTATION2_CONTROL_ADDR		    = 0x16
    ROTATION2_STATUS_ADDR		    = 0x17
    ROTATION2_ROTATION_ADDR		    = 0x18
    ROTATION2_CURRENT_ANGLE_ADDR    = 0x19
    ROTATION2_CURRENT_ANGLE2_ADDR   = 0x1A
    ROTATION3_CONTROL_ADDR		    = 0x1B
    ROTATION3_STATUS_ADDR		    = 0x1C
    ...
    WRIST_SERVO_CONTROL_ADDR		= 0x25
    CENTER_SERVO_CONTROL_ADDR	    = 0x26
    GRABBER_SERVO_CONTROL_ADDR		= 0x27
    
    DEBUG0_STATUS_ADDR			    = 0x28
    DEBUG1_STATUS_ADDR			    = 0x29
    DEBUG2_STATUS_ADDR			    = 0x2A
    DEBUG3_STATUS_ADDR			    = 0x2B
    LED_CONTROL_ADDR			    = 0x2C

    PWM_PROFILE_BASE_ADDR           = 0x2D
