...
void notify()
{
  ...
  tx_buf[0] = 1;
  tx_buf[1] = PS4.LStickX()+128;
  tx_buf[2] = PS4.LStickY()+128;
  tx_buf[3] = PS4.RStickX()+128;
  tx_buf[4] = PS4.RStickY()+128;
  tx_buf[5] = (PS4.Square()<<3) | (PS4.Cross()<<2) | (PS4.Circle()<<1) | PS4.Triangle();

  sprintf(messageString, "%4d,%4d,%4d,%4d,%4d,%4d", tx_buf[0], tx_buf[1], tx_buf[2], tx_buf[3], tx_buf[4], tx_buf[5]);
